export const racingPageMeta = {
  title: "Empowering Outdoor Experiences Through Mountain Biking | Ride and Develop",
  description:
    "Ride and Develop, Inc. is a nonprofit dedicated to empowering individuals through mountain bike racing and outdoor recreation. We provide coaching, training, and financial support to foster personal growth and resilience in the Conejo Valley and surrounding areas.",
  keywords: ["mountain bike racing", "Langtown Racing Academy", "outdoor recreation"],
  path: "/racing",
};

export const alumniPageMeta = {
  title: "Alumni | Ride and Develop",
  description:
    "Former Langtown Racing Academy team members honored as Ride and Develop alumni.",
  keywords: ["mountain bike racing alumni", "Langtown Racing Academy"],
  path: "/racing/alumni",
};

/**
 * Alumni are added by hand here, the same way every racer used to be added
 * before theteam profiles could be approved and appended dynamically — see
 * `buildRacingTeam` in lib/racing-profiles.ts for that dynamic path. Alumni
 * are intentionally not wired into that system.
 */
export const alumni: {
  name: string;
  image: string | null;
...
export const featuredRacerDetails = [
  "Accomplishments: Husband and Father",
  "Coaching: USA Cycling Coach Level 3, PMBIA Level 1 and NICA Level 3 Instructor",
  "Bicycle Racing Levels Achieved: Downhill - UCI Elite, Enduro - Pro, Cyclocross - UCI Elite, Cross Country - Cat 1",
];

export const langtownLegacy = [
  "Langtown Racing started back in 1984 when Bobby Langin Sr bought a house with a backyard intended for a bicycle motocross practice track. What started as training quickly turned into friends gathering to battle on mini bikes. An annual event was born.",
  "Over time the event grew, attracting the attention of magazines, television and the stars of the sport. Despite the growing media attention Bobby Sr and his wife Linda opened their doors to hundreds each year shining on the community around them.",
  "Spectators were never charged and any money donated went to the pro purse and charities. RAD and Langtown Racing Academy want to honor the legacy by fostering a spirit of community, promoting good character, trail stewardship and racing until our legs fall off.",
];
